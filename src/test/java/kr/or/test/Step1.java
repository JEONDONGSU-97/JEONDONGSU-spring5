 ...
 */
public class Step1 {
	public void Step1() { //클래스명과 같은 이름의 메서드를 생성자 메서드 자동으로 만들어 진다.
		//자동으로 만들어 진다.
	...
	public static void main(String[] args) {
		...
		//변수에 값을 입력(아래)
		name = "홍길동";
		age = 10;//자바스크립트 보다는 자료형 사용에 엄격하다.
		phoneNum = "000-0000-0000";//1문장 끝을 명시(세미콜론이).
		...
		//메서드명이 같다. 단, 로드(loading..)된 파라미터 타입,개수 다른 메서드를 호출=오버로드 
	}
