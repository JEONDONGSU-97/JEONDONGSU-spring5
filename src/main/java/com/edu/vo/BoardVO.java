...
/**
 * 이 클래스는 게시물 CRUD에 필요한 멤버변수(필드)가 정의된 클래스이다.
 * 목적은 데이터 변수값 이동시 Get/Set 작업이 주 목적이다.
 * @author 전동수
 *
 */
public class BoardVO {
	...
	//private String save_file_name; 첨부파일이 1개 이상 일 수 있기 때문에
	//게시물 1개 등록시, 첨부파일 1개이상 필요하다. 그런데 1개의 필드에 여러개를 입력 할 수 없다.
	//그래서 DB(테이블)에 없는 가상 멤버변수(필드)를 2개 만든다.
